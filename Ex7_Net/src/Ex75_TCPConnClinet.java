...
public class Client {
    ...
    public void send() {
        ...
        sendMessage(frame.getTitle() + "r#$@%^q" + "ALL" + "r#$@%^q" + message);
    ...
    public boolean connectServer(int port, String hostIp, String name) {
        ...
        try {
            ...
            sendMessage(name + "r#$@%^q" + socket.getLocalAddress().toString());
            // 开启接收消息的线程  
            messageThread = new Thread(new MessageThread(reader, textArea));
